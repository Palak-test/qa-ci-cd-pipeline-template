...
## [4.14.1](https://github.com/Palak-test/qa-ci-cd-pipeline-template/compare/containerlabpy-v4.14.0...containerlabpy-v4.14.1) (2026-01-31)


### Bug Fixes

* Allow passing in a custom wait strategy string in MySQL, Cassandra, Kafka and Trino ([#953](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/953)) ([be4d09e](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/be4d09ecb3f65089d06fbd1ab9d4f12e9009ed8b))
* **compose:** expose useful compose options ([#951](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/951)) ([183e1aa](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/183e1aa1bcd684d36d3f5b52b28965c851f5436f))
* **core:** bring back dind tests ([7337266](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/7337266c73f05f003378ff483a5e3b565a1e86c5))
* **core:** Use WaitStrategy internally for wait_for function ([#942](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/942)) ([e323317](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/e323317838552a9f8046b2a8e24a03c07ff8890e))
* **nats:** add support for jetstream ([#938](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/938)) ([49c9af8](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/49c9af8cf542feb5df9ec389d554edd7645a4dc4))
* Support Elasticsearch 9.x ([#881](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/881)) ([f690e88](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/f690e88e866ef3ff30ba2cd18958fc1fc07f89c8)), closes [#860](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/860)

## [4.14.0](https://github.com/Palak-test/qa-ci-cd-pipeline-template/compare/containerlabpy-v4.13.3...containerlabpy-v4.14.0) (2026-01-07)


### Features

* Add ExecWaitStrategy and migrate Postgres from deprecated decorator ([#935](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/935)) ([2d9eee3](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/2d9eee30442ec8adbf4a42fcd308cd6377b41c06))


### Bug Fixes

* add ruff to deps ([#919](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/919)) ([5853d32](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/5853d326bb4e9631b7c58355c53ff7fc3ecab92d))
* **cassandra,mysqk,kafka:** Use wait strategy instead of deprecated wait_for_logs ([#945](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/945)) ([b7791b9](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/b7791b945134940c3185baa3eab009f06d0338a9))
* **core:** recreate poetry lockfile with latest versions of libraries ([#946](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/946)) ([9a97385](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/9a9738575ec3f831c78512b10b990e416eacad03))
* **elasticsearch:** Use wait strategy instead of deprecated decorator ([#915](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/915)) ([c785ecd](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/c785ecdca20b51e077ab23ed61ae123c643a0627))
* **minio:** minio client requires kwargs now ([#933](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/933)) ([37f5902](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/37f590278f23851c4f8244d4add7aa6f8ed3bc62))
* **minio:** Use wait strategy instead of deprecated decorator ([#899](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/899)) ([febccb7](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/febccb78b5b4b00d2a3bda27f09e6b4d4c9dfde3))

## [4.13.3](https://github.com/Palak-test/qa-ci-cd-pipeline-template/compare/containerlabpy-v4.13.2...containerlabpy-v4.13.3) (2025-11-14)
...
## [4.13.2](https://github.com/Palak-test/qa-ci-cd-pipeline-template/compare/containerlabpy-v4.13.1...containerlabpy-v4.13.2) (2025-10-07)


### Bug Fixes

* **core:** Fix issues with doctests ([#893](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/893)) ([2e4d80a](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/2e4d80ade5a2048c8bc79d7a2438004b8e0954e4))
* **core:** waiting improvements + remove decorators in core ([#894](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/894)) ([f93f379](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/f93f379380a9de769fe6a1e1168622865cdf613d))
* issue [#889](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/889) by changing the annotated return type of `waiting_for` to `Self`. ([#890](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/890)) ([fe941b1](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/fe941b17bb97aad15dc4844996f166c9308f4476))
* **mongo:** mongo start waiting forever for old mongo versions ([#783](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/783)) ([1388612](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/13886120e9cb72666a40ea3691ea13e584805918))
* **redpanda:** copy the startup script to a path that can be written … ([#867](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/867)) ([e6b976d](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/e6b976de43fc6fe90d7131fd25983f9c6b08429b))
* **trino:** Remove deprecated class and decorator from Trino container ([#895](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/895)) ([bb646e9](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/bb646e903236a1df72bc38dbb47d1dba95527198))

## [4.13.1](https://github.com/Palak-test/qa-ci-cd-pipeline-template/compare/containerlabpy-v4.13.0...containerlabpy-v4.13.1) (2025-09-24)


### Bug Fixes

* **core:** Added 'compose' in compose_command_property ([#879](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/879)) ([769b7b6](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/769b7b688fe254cb8e38e05f453c4e3fe7999ad5))
* **core:** make sure context manager exits ([#876](https://github.com/Palak-test/qa-ci-cd-pipeline-template/issues/876)) ([10089f6](https://github.com/Palak-test/qa-ci-cd-pipeline-template/commit/10089f6e2fe07e53cc47a69521e67a1bf3310065))
